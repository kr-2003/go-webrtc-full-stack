    ...
    return (
        <>
            ...
            <div className='h-[90%]'>
                ...
                <div className='grid grid-cols-4 h-[90%] place-content-center' id="peers">
                    <div className="flex items-center justify-center col-span-3 columns is-multiline w-[100%] place-content-center" id="videos">
                        <div className="column is-6 peer w-[90%] h-[95%] place-content-center">
                            <video id="localVideo" className="flex-1 object-cover video-area mirror w-[100%] h-[90%] place-content-center" autoPlay muted></video>
                        </div>
                    </div>
